...
- **Azure** pela infraestrutura de cloud.
- **PostgreSQL** pela robustez em RDBMS.
- **Streamlit** pela simplicidade em construir dashboards.
- **Poetry** pela gerência de dependências determinística.

---

**Desenvolvido com ❤️ focando em qualidade, resiliência e valor de negócio.**
